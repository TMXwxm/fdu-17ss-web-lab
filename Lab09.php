...
<body>
    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
              ...
              //<a href="list.php?country=Canada" role="button" class="btn btn-default"> Canada</a>
                for ($counter=0;$counter<count($continents);$counter++){
                    echo '<a href="list.php?country='.$continents[$counter].'" role="button" class="btn btn-default"> '.$continents[$counter].'</a>';
                }
              ?>
   ...
   //
          ...
          foreach ($images as $x){
              ...
              echo '<img src="images/square/'.$x["path"].'" alt="View of Cologne">';
              echo '<div class="caption">';
              echo '<div class="blur"></div>';
              echo '<div class="caption-text"><h1>'.$x["title"].'</h1></div>';
              echo '</a></li>';
          }
          ?>
